...
def dpto_por_unidad(request, pk):
    ...
    datos = [{'nombre': departamento.nombre, 'id': departamento.id} for departamento in departamentos]
...
def request_report():
    sql = 'SELECT adm_unidadorg.nombre AS "nombreUO", adm_unidadorg.id AS "idUO", ' \
          ...
          'adm_escalasalarial.salario_escala, ges_trab_trabajador.incre_res, ges_trab_trabajador.cies, ' \
          'ges_trab_trabajador.sal_plus, ges_trab_trabajador.antiguedad, ges_trab_trabajador.cat_cient, ' \
          'ges_trab_trabajador.fecha_alta, ges_trab_trabajador.id AS id, adm_departamento.codigo AS dptoCod, ' \
