...
class Trabajador(models.Model):
    ...
    licencia = models.CharField(max_length=20, blank=True, verbose_name='Licencia de conducción', choices=LICENCIA_OPT,
                                default='No procede')
    enfermedades = models.CharField(max_length=100, verbose_name='Enfermedades que padece', default='Ninguna', blank=True)
    ...
    usuario = models.CharField(max_length=20, verbose_name='Usuario', blank=True, null= True, default='Ninguno', unique=False)
    ...
    CONTRATO_OPT = (('1', 'Nombramiento'), ('2', 'Indeterminado'), ('3', 'Determinado'), ('4', 'Adiestramiento'),
                    ('5', 'Prestado otra Emp'), ('6', 'A prueba'), ('7', 'Reserva'), ('8', 'Disponible'))
    ...
    por_anti = models.CharField(choices=POR_ANTI_OPT, max_length=3, verbose_name="% Antiguedad", default=POR_ANTI_OPT[0])
    ...
    sal_cat_cient=models.PositiveIntegerField(verbose_name="Salario x cat. científica", blank=True, null=True)
    salario_total= models.DecimalField(max_digits=5, verbose_name='Salario Total', blank=True, null=True, decimal_places=2)
    salario_jornada_laboral= models.DecimalField(max_digits=5, verbose_name='Salario por Jornada Laboral', blank=True, null=True, default= 0.00 , decimal_places=2)
    # Datos docentes
    actividad = models.CharField(max_length=30, verbose_name="Actividad", blank=True, default='Ninguna')
    calificacion = models.ForeignKey(Calificacion, on_delete=models.DO_NOTHING, verbose_name="Calificación", blank=True, null=True)
    especialidad = models.ForeignKey(Especialidad, on_delete=models.DO_NOTHING, verbose_name="Especialidad", blank=True, null=True)
    ...
    ESCOLARIDAD_OPT = (
        ('6to', '6to Grado'), ('9no ', '9no Grado'), ('12mo ', '12mo Grado'), ('TM', 'Técnico Medio'), ('OC', 'Obrero Calificado'),
        ('Univ', 'Universitario'))
    ...
    TIPO_TEC = (
        ('TA', 'Tec. Administrativo'), ('TD ', 'Tec.Dirigente'), ('TP ', 'Tec. Plaza Profesional'), ('TN', 'Tec. No Titulado'), ('TU', 'Tec. Universitario'),
    ...
    ORG_DEF = (
        ('MTT', 'MTT'), ('FEI', 'FEI'),  ('BPD-LR ', 'BPD-LR'), ('BPD-PTG ', 'BPD-PTG'), ('U/R', 'U/R'), ('Imp', 'Imprescindible'))
        
    orga_defensa = models.CharField(max_length=20, verbose_name="Organización de defensa", choices=ORG_DEF)
    ...
    saya = models.CharField(max_length=4, blank=True)
...
#    zapato = models.CharField(max_length=2)
#    saya = models.CharField(max_length=5)
#    blusa = models.CharField(max_length=3)
#    pullover = models.CharField(max_length=2)
#    pitusa = models.CharField(max_length=5)
#    camisa = models.CharField(max_length=3)
#    derecho = models.BooleanField(verbose_name="Con derecho")
...
class Movimiento(models.Model):
    ...
    tipo = models.CharField(max_length=20, verbose_name="Tipo de movimiento", blank=True, null=True, default='No definido')
    ...
    salario_total_ant= models.DecimalField(max_digits=5, verbose_name='Salario Total', blank=True, null=True, decimal_places=2)
    salario_total_act= models.DecimalField(max_digits=5, verbose_name='Salario Total', blank=True, null=True, decimal_places=2)
    sal_plus_ant = models.DecimalField(max_digits=5, decimal_places=2, verbose_name='Salario plus', default=0.00)
    sal_plus_act = models.DecimalField(max_digits=5, decimal_places=2, verbose_name='Salario plus', default=0.00)
    def __str__(self):
...
class NucleoFamiliar(models.Model):
    ...
    salario_dev = models.DecimalField(max_digits=6, decimal_places=2, verbose_name='Salario que devenga', blank=True, null=True)
...
class Baja(models.Model):
    ...
    fecha_disponible = models.DateField(blank=True, verbose_name="Fecha de inicio disponibilidad", null=True)
    fecha_ingreso = models.DateField(verbose_name="Fecha de ingreso al organismo")
    especialidad = models.ForeignKey(Especialidad, on_delete=models.DO_NOTHING, verbose_name="Especialidad")
